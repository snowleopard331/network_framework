...
namespace Jovi
{
    ...
    public:
        ...
        _Callback(_Callback<Class, ParamType1, ParamType2, ParamType3, ParamType4> const& cb)
            : m_object(cb.m_object)
            , m_method(cb.m_method)
            , m_param1(cb.m_param1)
            , m_param2(cb.m_param2)
            , m_param3(cb.m_param3)
            , m_param4(cb.m_param4) {}
    };
...
namespace Jovi
{
    ...
    public:
        ...
        virtual void SetResult(QueryResult* pResult) = 0;
    ...
    public:
        ...
        void SetResult(QueryResult* pResult) 
        {
            CB::m_param1 = pResult;
        }
    ...
    class QueryCallBack<Class>
        :public _IQueryCallback<_Callback<Class, QueryResult*> >
    {
    private:
    ...
    class SQueryCallback<>
        : public _IQueryCallback<_SCallback<QueryResult*> >
    {
    private:
        typedef _SCallback<QueryResult*>    QC0;

    public:
        SQueryCallback(typename QC0::Method method, QueryResult* result)
